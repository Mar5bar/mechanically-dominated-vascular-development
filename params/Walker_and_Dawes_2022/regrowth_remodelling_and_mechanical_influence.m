...
params.N_walkers = 8;  % Number of initial walkers.
...
params.kappa = 0.3;       % Effectiveness of remodelling, between 0 and 1. 1 corresponds to perfect remodelling.
...
params.num_repeats = 100;         % Number of times to repeat simulation.
