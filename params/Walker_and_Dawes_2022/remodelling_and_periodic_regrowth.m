...
params.k = 0;         % The strength of alignment of walkers to the phi field, in [0,1].
params.kappa = 0.1;       % Effectiveness of remodelling, between 0 and 1. 1 corresponds to perfect remodelling.
...
params.num_repeats = 30;         % Number of times to repeat simulation.
params.reset_phi = false;        % Initialise weights to zero. Set to false to examine regrowth.
