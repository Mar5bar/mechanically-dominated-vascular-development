...
params.N_agents = 20;  % Number of initial agents.
params.speed = 0.01;    % Linear speed of the agents, here fixed. Should be such that agents do not attempt to draw over themselves.
params.k = 0.8;         % The strength of alignment of agents to the phi field, in [0,1].
...
params.splitting_angle = pi/6;  % Half-angle of split agents, in radians,
